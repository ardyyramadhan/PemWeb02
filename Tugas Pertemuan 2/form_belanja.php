    ...
    <div class="container">
        <form method="POST" action="form_belanja.php">
            <div class="form-group row">
                <label class="col-4 col-form-label" for="pembeli">Pembeli</label>
                <div class="col-8">
                    <input id="pembeli" name="pembeli" placeholder="Nama Pembeli" type="text" required="required" class="form-control">
                </div>
            </div>
            <div class="form-group row">
